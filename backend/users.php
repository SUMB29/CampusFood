...
// Delete recipient if requested
if (isset($_GET['delete'])) {
    $id = intval($_GET['delete']);
    $conn->query("DELETE FROM users WHERE id=$id AND role='recipient'");
    header("Location: users.php");
    exit();
}

// Fetch all recipients
$result = $conn->query("SELECT * FROM users WHERE role='recipient'");
?>
<!DOCTYPE html>
<html>
<head>
...
<body class="bg-gray-100 p-8">
    <div class="bg-white shadow-md rounded-lg p-6">
        <h2 class="text-2xl font-bold mb-4">Recipient Users</h2>
